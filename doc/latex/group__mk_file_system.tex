...
\begin{DoxyCompactList}\small\item\em -\/--- P\+A\+T\+CH -\/--- \end{DoxyCompactList}\item 
...
\item[\mbox{\hyperlink{bug__bug000002}{Bug}}]Same issue with mkswap and swapon. Cleaning V\+Box config/settings, syncing and a bit of sleep fixed these issues for the {\itshape net-\/setup} method. 
