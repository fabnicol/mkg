\hypertarget{_2home_2fab_2_dev_2gentoolize_2scripts_2gentoolize_8sh-example}{}\doxysection{/home/fab/\+Dev/gentoolize/scripts/gentoolize.\+sh}

\begin{DoxyCode}{0}
\DoxyCodeLine{gentoolize language=fr minimal=\textcolor{keyword}{true} debug\_mode=\textcolor{keyword}{true} ncpus=8 nonroot\_user=ken passwd=\textcolor{stringliteral}{'util!Hx\&32F'} rootpasswd=\textcolor{stringliteral}{'Hk\_32!\_CD'} cleanup=\textcolor{keyword}{false}}
\end{DoxyCode}
...
\DoxyCodeLine{\textcolor{preprocessor}{\#}}
\DoxyCodeLine{\textcolor{preprocessor}{\# This file is part of gentoolize.}}
\DoxyCodeLine{\textcolor{preprocessor}{\#}}
\DoxyCodeLine{\textcolor{preprocessor}{\# gentoolize is free software; you can redistribute it and/or}}
...
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{preprocessor}{\#\# @file gentoolize.sh}}
...
\DoxyCodeLine{\textcolor{preprocessor}{\#\# gentoolize  [[switch=argument]...]  filename.iso  [1]}}
\DoxyCodeLine{\textcolor{preprocessor}{\#\# gentoolize  [[switch=argument]...]                [2]}}
\DoxyCodeLine{\textcolor{preprocessor}{\#\# gentoolize  help[=md]                             [3]}}
...
\DoxyCodeLine{\textcolor{preprocessor}{\#\# @par}}
\DoxyCodeLine{\textcolor{preprocessor}{\#\# Run: @code gentoolize help @endcode to print a list of possible switches and arguments.}}
\DoxyCodeLine{\textcolor{preprocessor}{\#\#}}
...
\DoxyCodeLine{\textcolor{preprocessor}{\#\# @code}}
\DoxyCodeLine{\textcolor{preprocessor}{\#\# gentoolize language=fr minimal=true debug\_mode=true ncpus=8 nonroot\_user=ken passwd='util!Hx\&32F' rootpasswd='Hk\_32!\_CD' cleanup=false}}
\DoxyCodeLine{\textcolor{preprocessor}{\#\# @endcode}}
\DoxyCodeLine{}
\DoxyCodeLine{cd ..}
\DoxyCodeLine{}
...
\DoxyCodeLine{}
\DoxyCodeLine{declare -\/a \mbox{\hyperlink{gentoolize_8sh_a214cb10953cb8efbb6a2092fdb4ff6fd}{ARR}}}
\DoxyCodeLine{}
\DoxyCodeLine{\mbox{\hyperlink{gentoolize_8sh_a214cb10953cb8efbb6a2092fdb4ff6fd}{ARR}}=(\textcolor{stringliteral}{"minimal"}     \textcolor{stringliteral}{"Remove *libreoffice* and *data science tools* from default list of installed software"}  \textcolor{stringliteral}{"false"}}
...
\DoxyCodeLine{     \textcolor{stringliteral}{"debug\_mode"}  \textcolor{stringliteral}{"Do not clean up gentoolize custom logs at root of gentoo system files before VM shutdown"}  \textcolor{stringliteral}{"false"}}
\DoxyCodeLine{     \textcolor{stringliteral}{"help"}          \textcolor{stringliteral}{"\(\backslash\)t This help"}                                                         \textcolor{stringliteral}{""}}
\DoxyCodeLine{}
\DoxyCodeLine{    )}
\DoxyCodeLine{}
\DoxyCodeLine{ARRAY\_LENGTH=\$((\$\{\#\mbox{\hyperlink{gentoolize_8sh_a214cb10953cb8efbb6a2092fdb4ff6fd}{ARR}}[*]\}/3))}
\DoxyCodeLine{}
...
\DoxyCodeLine{       exit -\/1}
\DoxyCodeLine{   fi}
\DoxyCodeLine{   local sw=\$\{\mbox{\hyperlink{gentoolize_8sh_a214cb10953cb8efbb6a2092fdb4ff6fd}{ARR}}[\$((\$1 * 3))]\}}
\DoxyCodeLine{   local desc=\$\{\mbox{\hyperlink{gentoolize_8sh_a214cb10953cb8efbb6a2092fdb4ff6fd}{ARR}}[\$((\$1 * 3 + 1))]\}}
\DoxyCodeLine{   local \textcolor{keywordflow}{default}=\$\{\mbox{\hyperlink{gentoolize_8sh_a214cb10953cb8efbb6a2092fdb4ff6fd}{ARR}}[\$((\$1 * 3 + 2))]\}}
...
\DoxyCodeLine{   echo \textcolor{stringliteral}{"**gentoolize**  [[switch=argument]...]  filename.iso  [1]  "}}
\DoxyCodeLine{   echo \textcolor{stringliteral}{"**gentoolize**  [[switch=argument]...]                [2]  "}}
\DoxyCodeLine{   echo \textcolor{stringliteral}{"**gentoolize**  help[=md]                             [3]  "}}
...
\DoxyCodeLine{   \textcolor{keywordflow}{for} ((i=0; i<ARRAY\_LENGTH; i++)); \textcolor{keywordflow}{do}}
\DoxyCodeLine{       local  capname=\$\{\mbox{\hyperlink{gentoolize_8sh_a214cb10953cb8efbb6a2092fdb4ff6fd}{ARR}}[\$((i * 3))]\string^\string^\}}
...
\DoxyCodeLine{\}}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{preprocessor}{\# mkvm.sh should be adjacent to gentoolize.sh}}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keyword}{function} create\_vm \{}
\DoxyCodeLine{   export \mbox{\hyperlink{gentoolize_8sh_ad1451b50408769582d8f5bd4254fe7b1}{PATH}}=\$\{\mbox{\hyperlink{gentoolize_8sh_ad1451b50408769582d8f5bd4254fe7b1}{PATH}}\}:\$\{VBPATH\}}
